...
function Show-Welcome {
    ...
    Add-Title "Welcome"
    Add-Divider 68
    Add-Sub "This wizard will install Lumara on your computer." 84
    Add-Sub "Lumara analyses and grades your street photography, builds sequenced stories, and gives editorial feedback — all running locally on your machine." 120
    Add-Divider 210
...
function Show-Installing {
    ...
    if ($ok) {
        ...
        try {
            ...
            $lnkPath  = Join-Path $desktop "Lumara.lnk"
            ...
            $s.Description      = "Lumara — AI Photo Curator"
            $s.Save()
