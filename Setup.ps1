...
function Show-Welcome {
    ...
    Add-Title "Welcome"
    Add-Divider 68
    Add-Sub "This wizard will install Cullwise on your computer." 84
    Add-Sub "Cullwise analyses and grades your street photography, builds sequenced stories, and gives editorial feedback — all running locally on your machine." 120
    Add-Divider 210
...
function Show-Installing {
    ...
    if ($ok) {
        ...
        try {
            ...
            $lnkPath  = Join-Path $desktop "Cullwise.lnk"
            ...
            $s.Description      = "Cullwise — AI Photo Curator"
            $s.Save()
