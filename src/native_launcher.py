...
"""
Lumara — native desktop launcher.
    ...
    try:
        ...
        if browser_path:
            if browser_type == "edge":
                ...
                profile_dir = Path(os.environ.get("LOCALAPPDATA", _ROOT)) / "Lumara" / "EdgeProfile"
                ...
                # Chrome app mode
                profile_dir = Path(os.environ.get("LOCALAPPDATA", _ROOT)) / "Lumara" / "ChromeProfile"
                profile_dir.mkdir(parents=True, exist_ok=True)
                ...
                # Firefox app mode
                profile_dir = Path(os.environ.get("LOCALAPPDATA", _ROOT)) / "Lumara" / "FirefoxProfile"
                profile_dir.mkdir(parents=True, exist_ok=True)
