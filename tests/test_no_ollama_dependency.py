...
Cullwise shipped with server.py returning 503 for every non-scan grade when
...
Step 4e (CULLWISE_STEP4E=1) and its helpers in qwen_vlm_grader/critique_engine.
...
# Opt-in only. Step 4e is gated on CULLWISE_STEP4E, which defaults to "0", and
