...
title FirstCut - One-Click Install
cd /d "%~dp0"

echo.
echo  ================================================================
echo    FirstCut  -  One-Click Installer
echo  ================================================================
echo.

:: ── Already installed? Just launch. ───────────────────────────────
if exist "venv\.setup_ok" (
    echo  FirstCut is already installed.
    echo  Launching...
...
echo  [3/4] Installing FirstCut components...
...
echo.
echo  ================================================================
echo   FirstCut is installed and launching now.
