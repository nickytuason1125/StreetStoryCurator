...
FirstCut is assembled from third-party libraries and pre-trained model weights.
...
- **LFM Open Licence v1.0** is Apache-2.0 in structure with one addition:
  ...
  FirstCut succeeds, which is the worst moment to discover it.
  ...
  environment variable: `FIRSTCUT_LOCAL_LLM_GGUF`.
