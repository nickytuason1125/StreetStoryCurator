# Lumara — Installation Guide

Lumara is a desktop app for grading, sequencing, and curating street photography. It runs fully offline on your computer — no internet required after setup.
...
1. Download and unzip the `lumara` folder anywhere on your computer (Desktop is fine)
2. Open the folder
3. Double-click **`Install Shortcut.bat`**
   - This places a **Lumara** shortcut on your Desktop
4. Double-click the **Lumara** shortcut on your Desktop
...
1. Download and unzip the `lumara` folder anywhere on your computer
...
3. Run this command to make the launcher executable (do this once only):
   ```
   chmod +x ~/Desktop/lumara/Start.command
   ```
   Replace `~/Desktop/lumara/` with the actual path if you put it somewhere else.
4. In Finder, open the `lumara` folder and double-click **`Start.command`**
...
- **Windows:** Double-click the **Lumara** shortcut on your Desktop
...
1. Delete the `lumara` folder
2. Delete the **Lumara** shortcut from your Desktop (Windows)
