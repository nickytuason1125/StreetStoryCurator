# FirstCut — Installation Guide

FirstCut is a desktop app for grading, sequencing, and curating street photography. It runs fully offline on your computer — no internet required after setup.
...
1. Download and unzip the `firstcut` folder anywhere on your computer (Desktop is fine)
2. Open the folder
3. Double-click **`Install Shortcut.bat`**
   - This places a **FirstCut** shortcut on your Desktop
4. Double-click the **FirstCut** shortcut on your Desktop
...
1. Download and unzip the `firstcut` folder anywhere on your computer
...
3. Run this command to make the launcher executable (do this once only):
   ```
   chmod +x ~/Desktop/firstcut/Start.command
   ```
   Replace `~/Desktop/firstcut/` with the actual path if you put it somewhere else.
4. In Finder, open the `firstcut` folder and double-click **`Start.command`**
...
- **Windows:** Double-click the **FirstCut** shortcut on your Desktop
...
1. Delete the `firstcut` folder
2. Delete the **FirstCut** shortcut from your Desktop (Windows)
